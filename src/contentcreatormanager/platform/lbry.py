...
class LBRY(contentcreatormanager.platform.platform.Platform):
    ...
    def api_channel_create(self, name : str, bid : float, title : str, description : str, email : str, website_url : str, thumbnail_url : str, cover_url : str, featured : list = [], tags : list = [], languages : list = []):
        """
        Method to make a channel_create call to the LBRY API
        Example Call: api_channel_create(name="@TestChannelToBeDeleted", bid=.001, title='Test Title Channel', description='Who Cares will be deleted', email='test@tiff.tech', website_url='http://google.com', thumbnail_url='', cover_url='', tags=['test'], languages=['en'])
        ...
        Example Call with Error: api_channel_create(name="TestChannelToBeDeleted", bid=.001, title='Test Title Channel', description='Who Cares will be deleted', email='test@tiff.tech', website_url='http://google.com', thumbnail_url='', cover_url='', tags=['test'], languages=['en'])
    ...
    def api_channel_update(self, claim_id : str, bid : float, title : str, description : str, email : str, 
                           website_url : str, cover_url : str, 
                           thumbnail_url : str, clear_tags : bool = True, clear_languages : bool = True, 
                           replace : bool = True, languages : list = [], tags : list = [], featured : list = []):
        """
        Method to make a channel_update call to the LBRY API
        Example Call: api_channel_update(claim_id='8be45e4ba05bd6961619489f6408a0dc62f4e650', bid=.005, title='Tiff Test Channel Updated', description="Tiff's Channel for Testing things", email='test@tiff.tech', website_url='http://google.com', cover_url='https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Test-Logo.svg/783px-Test-Logo.svg.png', thumbnail_url='https://e7.pngegg.com/pngimages/575/704/png-clipart-computer-icons-test-scalable-graphics-test-score-angle-pencil-thumbnail.png')
